...
###########################################################################
# Example Fluid Double Dam Break
#
# Two tall fluid columns collapse inward from opposite sides of a closed box.
# This public comparison version keeps the scene parameters fixed and only
# swaps between IPBF and PBF.
#
# Command: python -m newton.examples fluid_double_dam_break
#
###########################################################################
...
class Example:
    """Closed-box double dam break container for IPBF/PBF comparison."""
        ...
        self.solver = create_fluid_solver(
            ...
            scene={
                **particle_block,
                ...
                "static_boundary_weight": float(self._get_arg_or_scene_value("static_boundary_weight", particle_block)),
            },
