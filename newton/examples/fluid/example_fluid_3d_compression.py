...
# and collides with the floor and walls. This public comparison version keeps
# the scene parameters fixed and only swaps between IPBF and PBF.
#
# Command: python -m newton.examples fluid_3d_compression
#
###########################################################################
...
class Example:
    """Compressed spherical cloud test for IPBF/PBF comparison."""
