...
###########################################################################
# Example Fluid IPBF/PBF VBD Float Box Compare
#
...
#
# Command: python -m newton.examples fluid_ipbf_pbf_vbd_float_box_compare
#
###########################################################################
...
class Example:
    ...
    def create_parser():
        ...
        parser.add_argument(
            ...
            action=argparse.BooleanOptionalAction,
            default=False,
            help="Clamp particles against the comparison tank AABB after each substep.",
        )
        return parser
    ...
    def __init__(self, viewer, args=None):
        ...
        self.use_box_clamp = bool(getattr(self.args, "box_clamp", False))
