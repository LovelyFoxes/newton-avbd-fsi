    ...
    def _get_scene_config(self) -> dict[str, object]:
        ...
        if bool(getattr(self.args, "test", False)):
            config = {
                ...
                "box_half_extent": wp.vec3(0.080, 0.018, 0.020),
                "box_bottom_gap": 0.006,
                "box_density_float": 360.0,
                "box_density_sink": 1600.0,
                "rest_density": 1000.0,
                "fluid_iterations": 4,
                "sim_substeps": 5,
                "velocity_damping": 0.998,
                "viscosity_coefficient": 0.0015,
            ...
            config = {
                ...
                "pool_bottom_clearance": 0.012,
                "box_half_extent": wp.vec3(0.080, 0.080, 0.028),
                "box_bottom_gap": 0.004,
                "box_density_float": 180.0,
                "box_density_sink": 1650.0,
                "rest_density": 1000.0,
                "fluid_iterations": 8,
                "sim_substeps": 4,
                "velocity_damping": 0.999,
                "viscosity_coefficient": 0.0012,
                "viscosity_boundary_coefficient": 0.0,
                "xsph_coefficient": 0.0020,
                "xsph_boundary_coefficient": 0.0,
