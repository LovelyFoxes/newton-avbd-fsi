...
set "CONFIG_PATH=.blender\config\fluid_quasi2d_box_sink_panel.json"
set "DEVICE=cuda:0"
...
set "UV_CACHE_DIR=%TEMP%\uv-cache-fluid-q2d-box-sink"
set "UV_TOOL_DIR=%TEMP%\uv-tools-fluid-q2d-box-sink"
set "WARP_CACHE_PATH=%TEMP%\warp-cache-fluid-q2d-box-sink"
