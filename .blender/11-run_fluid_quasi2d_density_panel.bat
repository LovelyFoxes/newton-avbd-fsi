...
set "CONFIG_PATH=.blender\config\fluid_quasi2d_density_panel.json"
set "DEVICE=cuda:0"
set "RECORD_FRAMES=150"
set "EXPORT_CACHE=1"
set "RENDER_IMAGES=0"
set "SAVE_BLEND=1"
...
set "UV_CACHE_DIR=%TEMP%\uv-cache-fluid-q2d-density"
set "UV_TOOL_DIR=%TEMP%\uv-tools-fluid-q2d-density"
set "WARP_CACHE_PATH=%TEMP%\warp-cache-fluid-q2d-density"
